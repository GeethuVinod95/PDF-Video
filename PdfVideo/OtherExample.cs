...
public class OtherExample
	...
	public void CreatePage7Contents()
		...
		// location markers
		Page.AddLocationMarker("Page1", LocMarkerScope.NamedDest, DestFit.FitH, 10.5);
...
//		Barcode39 Barcode = new Barcode39(new Int32[] {43, 1, 2, 3, 4, 5, 6, 7, 8, 9, 0, 1, 2, 43});
	...
	public void Example7a
		...
		PdfDisplayMedia DisplayMedia = new PdfDisplayMedia(PdfEmbeddedFile.CreateEmbeddedFile(Document, @"C:\Test\sam.mp4"));
